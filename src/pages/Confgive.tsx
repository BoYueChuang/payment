...
const CONFGive = () => {
    ...
    // **初始化設定 **
    useEffect(() => {
        console.log(import.meta.env.VITE_TAPPAY_APP_ID, "VITE_TAPPAY_APP_ID");
        console.log(import.meta.env.VITE_TAPPAY_APP_KEY, "VITE_TAPPAY_APP_KEY");
        console.log(import.meta.env.VITE_APPLE_MERCHANT_ID, "VITE_APPLE_MERCHANT_ID");
        console.log(import.meta.env.VITE_GOOGLE_MERCHANT_ID, "VITE_GOOGLE_MERCHANT_ID");
